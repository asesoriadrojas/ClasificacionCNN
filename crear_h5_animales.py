...
#SE DEBE CAMBIAR LA RUTA DONDE SE ENCUENTREN LAS IMAGENES DE LOS DATOS.
parent_dir='C:\\Intel\\DeepLearningMarzo2019\\Herramientas_desarrollo_DeepLearning-20190504\\ListadoObjetos_Prendas-20190508T220555Z-001\\ListadoObjetos_Prendas'
file_ext='*.jpg'
classes_id={
              'Camisalarga':0,
              'camisasmangacorta':1,        
...
with h5py.File('Prendas_train_dataset.h5','w') as h5data:
    h5data.create_dataset('train_set_x',data=X_train)
    h5data.create_dataset('train_set_y',data=X_test)
with h5py.File('Prendas_test_dataset.h5','w') as h5data:
