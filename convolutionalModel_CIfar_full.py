...
#        # Calcular la predicción sobre el conjunto de test 
        ...
        save_path = saver.save(sess, "C:\Intel\DeepLearningMarzo2019\RedesConvolucionales_Clase1_empty (1)\RedesConvolucionales_Clase1_empty\cifar-10-batches-py\\model_softmax_Cifar3Capas_batch.ckpt")
